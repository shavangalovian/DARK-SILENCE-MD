...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~uYZS0a7a#UzNseh3WTdFM3ulzrUh36unWFBHNkvsGgKjnlaB1Mrs",
    CAPTION: process.env.CAPTION || "POWERED BY PAPSY KE",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR DO YOU WANT A FRIEND",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "254795001271",
    OWNER_NAME: process.env.OWNER_NAME || "➺ѕเℓεɳƭ_ℓσѵε૨࿐",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺PAPSY-KE-MD",
    STATUS_REPLY: process.env.STATUS_REPLY || "`STATUS SEEN🏳️‍🌈❣️`",
